...
def _hparams(algorithm, dataset, random_seed):
    ...
    if dataset in SMALL_IMAGES:
        ...
        _hparam('lr', 1e-2, lambda r: 10**r.uniform(-5, -3.5))
    ...
    if algorithm in ['DANN', 'CDANN', 'FedBR_DANN', 'FedBR_DCDANN', 'FedBR_DCDANN_Lite'] and dataset in SMALL_IMAGES:
        _hparam('lr_g', 1e-3, lambda r: 10**r.uniform(-4.5, -2.5))
    elif algorithm in ['DANN', 'CDANN', 'FedBR_DANN', 'FedBR_DCDANN', 'FedBR_DCDANN_Lite']:
        _hparam('lr_g', 1e-2, lambda r: 10**r.uniform(-5, -3.5))
