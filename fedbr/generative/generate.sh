...
python3 ./fedbr/generative/generate.py --gpu_index $gpu_index --root_path $root_path --model $model  --generate_dataset $generate_dataset \
--batch_size 10 --sample 20 --noise_num 10 --image_resolution 32  --style_gan_style_dim 64  --style_gan_n_mlp 1  --style_gan_cmul 1
