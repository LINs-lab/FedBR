...
"""
Example usage:
python -u -m fedbr.scripts.list_top_hparams \
    --input_dir fedbr/misc/test_sweep_data --algorithm ERM \
...
from fedbr.lib import misc, reporting
from fedbr import model_selection
from fedbr.lib.query import Q
import warnings
